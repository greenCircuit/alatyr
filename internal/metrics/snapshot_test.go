...
func TestRecordMesh_EnrollmentBreakdown(t *testing.T) {
	shopEnrolled := models.WorkloadNode{ID: "uid-a", Label: "a", Namespace: "shop", Type: models.NodeTypeService}
	shopNotEnrolled := models.WorkloadNode{ID: "uid-b", Label: "b", Namespace: "shop", Type: models.NodeTypeService}
	shopNs := models.WorkloadNode{ID: "ns-shop", Namespace: "shop", Type: models.NodeTypeNamespace}
	billingPermissive := models.WorkloadNode{ID: "uid-c", Label: "c", Namespace: "billing", Type: models.NodeTypeService}
...
func TestRecordMesh_MtlsUnenrolledNotSmeared(t *testing.T) {
	workload := models.WorkloadNode{ID: "uid-a", Label: "a", Namespace: "shop", Type: models.NodeTypeService}
	cache := &models.Cache{
